...
namespace keisoku.Migrations
{
    ...
    [Migration("20190513080936_Fourteen")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("keisoku.Models.AiKaisekiCadModel", b =>
                {
                    ...
                    b.Property<int?>("AiKaisekiAnkenId");

                    b.Property<int?>("AiKaisekiCustomerId");

                    b.Property<int?>("AiKaisekiTunnelId");
                    ...
                    b.HasIndex("AiKaisekiCustomerId", "AiKaisekiAnkenId", "AiKaisekiTunnelId");

                    b.ToTable("AiKaisekiCads");
                });

            modelBuilder.Entity("keisoku.Models.AiKaisekiModel", b =>
                {
                    ...
                    b.ToTable("AiKaisekis");
                });

            modelBuilder.Entity("keisoku.Models.AiKaisekiPdfModel", b =>
                {
                    b.Property<int>("AiKaisekiPdfId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("AiKaisekiPdfId");

                    b.HasIndex("AiKaisekiCustomerId", "AiKaisekiAnkenId", "AiKaisekiTunnelId");

                    b.ToTable("AiKaisekiPdfs");
                });
            ...
            modelBuilder.Entity("keisoku.Models.EditCadModel", b =>
                {
                    b.Property<int>("CustomerId");
                    ...
                    b.HasKey("CustomerId", "AnkenId", "TunnelId", "EditCadId");
            ...
            modelBuilder.Entity("keisoku.Models.FileShareModel", b =>
                {
                    b.Property<int>("CustomerId");
                    ...
                    b.HasKey("CustomerId", "AnkenId", "TunnelId", "FileShareId");

                    b.ToTable("FileShares");
                });

            modelBuilder.Entity("keisoku.Models.HibiwareShoriSetModel", b =>
                {
                    b.Property<int>("CustomerId");
                    ...
                    b.Property<decimal>("KaikouhabaMojiSize");

                    b.Property<double>("ShortLineRemove");

                    b.Property<DateTime>("UpdatedAt");

                    b.HasKey("CustomerId", "AnkenId", "TunnelId");

                    b.ToTable("HibiwareShoriSets");
                });

            modelBuilder.Entity("keisoku.Models.ImageOrderSetModel", b =>
                {
                    b.Property<int>("CustomerId");
                    ...
                    b.Property<int>("ImageOrderSetId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<DateTime>("CreatedAt");

                    b.Property<int>("ImageAlignPosition");

                    b.Property<decimal>("KitenKirotei");

                    b.Property<decimal>("Length");

                    b.Property<int>("SeikahinImageId");

                    b.Property<string>("SpanMoji");

                    b.Property<DateTime>("UpdatedAt");

                    b.Property<int>("WidthOrHeight");

                    b.HasKey("CustomerId", "AnkenId", "TunnelId", "ImageOrderSetId");
            ...
            modelBuilder.Entity("keisoku.Models.KakinModel", b =>
                {
                    b.Property<int>("CustomerId");
            ...
            modelBuilder.Entity("keisoku.Models.KoukaisakiCustomerModel", b =>
                {
                    b.Property<int>("KoukaisakiCustomerId");

                    b.Property<int>("KoukaisakiAnkenId");
            ...
            modelBuilder.Entity("keisoku.Models.OtameshiKinouModel", b =>
                {
                    b.Property<int>("CustomerId");
                    ...
                    b.ToTable("OtameshiKinous");
                });

            modelBuilder.Entity("keisoku.Models.OtameshiPreviewModel", b =>
                {
                    b.Property<int>("CustomerId");
                    ...
                    b.HasKey("CustomerId", "AnkenId", "TunnelId", "SeikahinImageId");

                    b.ToTable("OtameshiPreviews");
                });
            ...
            modelBuilder.Entity("keisoku.Models.PrintDetailModel", b =>
                {
                    b.Property<int>("CustomerId");
                    ...
                    b.HasKey("CustomerId", "AnkenId", "TunnelId", "PrintFormatId");

                    b.HasIndex("PrintFormatId");

                    b.ToTable("PrintDetails");
                });

            modelBuilder.Entity("keisoku.Models.PrintFormatModel", b =>
                {
                    b.Property<int>("PrintFormatId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("PrintFormatKubun");

                    b.Property<string>("PrintFormatName");

                    b.Property<DateTime>("UpdatedAt");

                    b.HasKey("PrintFormatId");

                    b.ToTable("PrintFormats");
                });

            modelBuilder.Entity("keisoku.Models.PrintSetModel", b =>
                {
                    b.Property<int>("CustomerId");
                    ...
                    b.Property<decimal>("ImageCompressionRatio");

                    b.Property<DateTime>("UpdatedAt");

                    b.HasKey("CustomerId", "AnkenId", "TunnelId");

                    b.ToTable("PrintSetModel");
                });
            ...
            modelBuilder.Entity("keisoku.Models.SelectItemModel", b =>
                {
                    b.Property<string>("SelectItemBunruiId");

                    b.Property<int>("SelectItemId");

                    b.Property<DateTime>("CreatedAt");

                    b.Property<string>("SelectItemName");

                    b.Property<DateTime>("UpdatedAt");

                    b.HasKey("SelectItemBunruiId", "SelectItemId");
            ...
            modelBuilder.Entity("keisoku.Models.TunnelImageModel", b =>
                {
                    ...
                    b.Property<int?>("OtameshiKinouModelAnkenId");

                    b.Property<int?>("OtameshiKinouModelCustomerId");

                    b.Property<int?>("OtameshiKinouModelTunnelId");
                    ...
                    b.HasIndex("OtameshiKinouModelCustomerId", "OtameshiKinouModelAnkenId", "OtameshiKinouModelTunnelId");
            ...
            modelBuilder.Entity("keisoku.Models.AiKaisekiCadModel", b =>
                {
                    b.HasOne("keisoku.Models.AiKaisekiModel", "AiKaiseki")
                        .WithMany("AiKaisekiCads")
                        .HasForeignKey("AiKaisekiCustomerId", "AiKaisekiAnkenId", "AiKaisekiTunnelId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("keisoku.Models.OtameshiPreviewModel", b =>
                {
                    b.HasOne("keisoku.Models.OtameshiKinouModel", "OtameshiKinou")
                        .WithMany("OtameshiPreviews")
                        .HasForeignKey("CustomerId", "AnkenId", "TunnelId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("keisoku.Models.PrintDetailModel", b =>
                {
                    b.HasOne("keisoku.Models.PrintFormatModel", "PrintFormat")
                        .WithMany("PrintDetails")
                        .HasForeignKey("PrintFormatId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("keisoku.Models.PrintSetModel", "PrintSet")
                        .WithMany("PrintDetails")
                        .HasForeignKey("CustomerId", "AnkenId", "TunnelId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("keisoku.Models.TunnelImageModel", b =>
                {
                    ...
                    b.HasOne("keisoku.Models.OtameshiKinouModel")
                        .WithMany("TunnelImages")
                        .HasForeignKey("OtameshiKinouModelCustomerId", "OtameshiKinouModelAnkenId", "OtameshiKinouModelTunnelId");
                });
